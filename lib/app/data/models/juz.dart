class Juz {
  ...
  Juz.fromJson(Map<String, dynamic> json) {
    juz = json['juz'];
    juzStartSurahNumber = json['juzStartSurahNumber'] == null
        ? null
        : json['juzStartSurahNumber'];
    juzEndSurahNumber =
        json['juzEndSurahNumber'] == null ? null : json['juzEndSurahNumber'];
    juzStartInfo = json['juzStartInfo'] == null ? null : json['juzStartInfo'];
    juzEndInfo = json['juzEndInfo'] == null ? null : json['juzEndInfo'];
    totalVerses = json['totalVerses'] == null ? null : json['totalVerses'];
    if (json['verses'] != null) {
      verses = <Verses>[];
